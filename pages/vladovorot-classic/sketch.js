...
function wheelSketch(_p5) {
    ...
    _p5.setVideos = function (videosList) {
        video = new Video(window.WHEEL_VIDEOS || videosList);
    };
    ...
    _p5.setup = () => {
        ...
        _p5.textSize(23);
        _p5.textFont('Montserrat, Calibri, Arial, sans-serif');
        _p5.textLeading(24);
        _p5.fill(200);
        ...
        button.attribute('aria-label', 'Roll');
        button.attribute('title', 'Roll');
    ...
    _p5.draw = () => {
        ...
        */
        ...
        for (let i = -data.length - 2; i < itemsPerScreen + 1; i++) {
            ...
            _p5.fill(255, 240, 214, Math.round(_p5.map(x + 50, centerX, centerX + radius, 0, 255, true)));
